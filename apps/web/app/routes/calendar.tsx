    ...
    <div className="p-container-padding grid grid-cols-1 lg:grid-cols-3 gap-card-gap">
      ...
      <div className="space-y-card-gap">
        <Card className="p-container-padding">
          <h3 className="font-headline-sm text-headline-sm mb-4">게시 빈도</h3>
          <div className="space-y-4">
            {cadenceStats.map((s) => (
              <div key={s.platform} className="flex items-center justify-between">
                ...
                <span className="font-body-md text-body-md font-semibold tabular-nums">{s.perWeek}<span className="text-on-surface-variant font-normal text-label-muted">건/주</span></span>
              </div>
            ))}
          </div>
        </Card>
        ...
        <Card className="p-container-padding">
          <h3 className="font-headline-sm text-headline-sm mb-4">포맷 구성</h3>
